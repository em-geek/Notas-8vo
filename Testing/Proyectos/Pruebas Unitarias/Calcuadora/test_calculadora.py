...
# Pruebas para sumar
    ...
    def test_sumar_caracter_y_numero(self):
        self.assertEqual(self.calc.sumar('X', 2), 'Solo se pueden sumar numeros')
    
    def test_sumar_numero_y_caracter(self):
        self.assertEqual(self.calc.sumar(2, 'X'), 'Solo se pueden sumar numeros')
    
    def test_sumar_negativo_y_numero(self):
        self.assertEqual(self.calc.sumar(-2, 2), 'Solo se puede sumar numeros positivos y el cero')
    
    def test_sumar_flotante_y_numero(self):
        self.assertEqual(self.calc.sumar(4.5, 2), 'Solo se puede sumar numeros enteros')
    ...
    def test_restar_positivo_y_negativo(self):
        self.assertEqual(self.calc.restar(2, -2), 'Solo se puede restar numeros positivos y el cero')
    
    def test_restar_caracter_y_numero(self):
        self.assertEqual(self.calc.restar('X', 2), 'Solo se pueden restar numeros')
    
    def test_restar_flotante_y_numero(self):
        self.assertEqual(self.calc.restar(4.5, 2), 'Solo se puede restar numeros enteros')
    ...
    def test_multiplicar_negativo_y_numero(self):
        self.assertEqual(self.calc.multiplicar(-1, 2), 'Solo se puede multiplicar numeros positivos y el cero')
    
    def test_multiplicar_flotante_y_numero(self):
        self.assertEqual(self.calc.multiplicar(3.5, 2), 'Solo se puede multiplicar numeros enteros')
    
    def test_multiplicar_caracter_y_numero(self):
        self.assertEqual(self.calc.multiplicar('X', 2), 'Solo se pueden multiplicar numeros')
    ...
    def test_dividir_diez_entre_cero(self):
        self.assertEqual(self.calc.dividir(10, 0), 'Solo se puede dividir positivos')
    
    def test_dividir_cero_entre_diez(self):
        self.assertEqual(self.calc.dividir(0, 10), 'Solo se puede dividir positivos')
    
    def test_dividir_caracter_y_numero(self):
        self.assertEqual(self.calc.dividir('X', 2), 'Solo se pueden dividir numeros')
    
    def test_dividir_flotante_y_numero(self):
        self.assertEqual(self.calc.dividir(3.5, 2), 'Solo se puede dividir numeros enteros')
