Característica: Dividir dos números
    Como usuario de la calculadora
    Quiero dividir dos números
    Para obtener el cociente correcto
    ...
    Escenario: Dividir 10 entre 0
        ...
        Cuando realizo la operación de división
        Entonces puedo ver el mensaje "Solo se puede dividir positivos"

    Escenario: Dividir 0 entre 10
        Dado que ingreso el número "0" y el número "10"
        Cuando realizo la operación de división
        Entonces puedo ver el mensaje "Solo se puede dividir positivos"

    Escenario: Dividir caracter y número
